<%-- 
    ...
    Created on : 14-nov-2017, 21:01:26
    Author     : Pancho
--%>
...
<html>
    <head>
        <meta charset="UTF-8"/>
        <title>Veterinaria Pet Land | Edición del Cliente</title>
    ...
    <body background="img/bgForm.jpg">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="active">Edición Cliente</li>
            </ol>
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form:form methot="POST" commandName="cliente">
                        ...
                        <hr/>
                        <input type="submit" value="Editar Cliente" class="form-control"/>
                    </form:form>
                </div>
            </div>
        </div>
