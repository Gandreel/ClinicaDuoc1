<%-- 
    Document   : mascota
    Created on : 14-nov-2017, 21:27:38
    Author     : Pancho
--%>
...
<html>
    <head>
        <meta charset="UTF-8"/>
        <title>Veterinaria Pet Land | Registro de Mascotas</title>
        ...
        <div class="container">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    ...
                    <h4>Recuerde que los campos con (*) son OBLIGATORIOS.</h4>
                </div>
                <div class="panel-body">
                    <form:form methot="POST" commandName="mascota">
                        ...
                        <hr/>
                        <input type="submit" value="Agregar Mascota" class="form-control"/>
                    </form:form>
                </div>
            </div>
        </div>
