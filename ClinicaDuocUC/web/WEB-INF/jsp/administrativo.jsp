<%-- 
    ...
    Created on : 21-may-2018, 23:46:28
    Author     : Pancho
--%>
    ...
    <body background="img/bgForm.jpg">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="active">Agregar Personal Administrativo</li>
            </ol>
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <div class="text-center">
                        <img src="img/persAdm.png" class="img-fluid" alt="Responsive image" width="350" height="250"> <br/>
                    </div>
                    <h4>Recuerde que todos los datos con (*) son OBLIGATORIOS.</h4>
                </div>
                <div class="panel-body">
                    <form:form methot="POST" commandName="administrativo">
                        <h1>Agregar a un Personal Administrativo</h1>
                        ...
                        <hr/>
                        <input type="submit" value="Agregar Personal Administrativo" class="form-control btn btn-success"/>
                    </form:form>
                </div>
            </div>
        </div>
