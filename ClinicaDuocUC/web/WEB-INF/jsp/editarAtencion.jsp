<%-- 
    Document   : editarAtencion
    Created on : 15-nov-2017, 23:14:40
    Author     : Pancho
--%>
...
<html>
    <head>
        <meta charset="UTF-8"/>
        <title>Veterinaria Pet Land | Edición de Atenciones</title>
    ...
    <body background="img/bgForm.jpg">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="active">Editar Atención</li>
            </ol>
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form:form methot="POST" commandName="atencion">
                        ...
                        <hr/>
                        <input type="submit" value="Editar Atención" class="form-control"/>
                    </form:form>
                </div>
            </div>
        </div>
