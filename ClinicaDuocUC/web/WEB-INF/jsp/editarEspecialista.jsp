<%-- 
    Document   : editarEspecialista
    Created on : 22-may-2018, 14:42:44
    Author     : Pancho
--%>
...
<html>
    <head>
        <meta charset="UTF-8"/>
        <title>Clinica DuocUC | Edición de Personal Médico</title>
    ...
    <body background="img/bgForm.jpg">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="active">Editar Personal Médico</li>
            </ol>
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form:form methot="POST" commandName="especialista">
                        <h1>Editar a un Personal Médico</h1>
                        ...
                        <hr/>
                        <input type="submit" value="Editar Personal Médico" class="form-control btn btn-success"/>
                    </form:form>
                </div>
            </div>
        </div>
